                ...
                <section>  
                 <ul>
                  ...
                  <div class="page" id="p1">
                     <li class="icon fa fa-home"><span class="title">Welcome my</span><h4>Sentrets </h4><p>Check if Furett is live streaming.</p><div class="primary-button"><a href="#t3">To the sentret crib</a></div></li>
                  </div>
                  <div class="page" id="p2">
                    <li class="icon fa fa-user"><span class="title">About Me</span>
                    <div class="container">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="left-text">
                            <h4>I am Furett</h4>
                            <p>Hello I am Furett, 17 years old and a webdevelopment student. I am beginning with livestreaming, I play games, make really bad art and off all things... I have fun with friends! I made this site to see what I could make of it around the theme of livestreaming. So here I am to put info about my livestreams onto this website!
                  ...
                  <div class="page" id="p3">
                    <li class="icon fa fa-image"><span class="title">am I live?</span>
                      <div class="container">
                        <div class="row">
                  ...
                  <p class="credit">Copyright &copy; 2019 Furett
